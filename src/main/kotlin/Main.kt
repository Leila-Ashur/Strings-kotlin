...
fun main() {
    var gets= give(listOf("ree","ray","ryan","rick","roy","rakeem","riri","riya","reyna","roro"))
    println(gets)
    val people =listOf(1.7,1.6,1.9,1.8,2.7,3.7)
    val (x,y) = manHeight(people)
    println("Total  $x")
    println("Average $y")
    human()
    var cars = listOf(
...
fun manHeight (height:List<Double>):Pair<Double,Double>{
    val a = height.sum()
...
fun human() {
    val persons1 = Person("val", 2, 145.5, 87.8)
    val persons2 = Person("ceshy", 18, 160.8, 30.6)
    val persons3 = Person("John", 10, 200.5, 90.8)
